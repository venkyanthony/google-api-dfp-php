<?php
/**
 * Contains all client objects for the ContentBundleService service.
 *
 * PHP version 5
 *
...
class DeactivateContentBundles extends ContentBundleAction {
   ...
   */
  public function getXsiTypeName() {
    return "DeactivateContentBundles";
  }
...
class ExcludeContentFromContentBundle extends ContentBundleAction {
   ...
   */
  public function getXsiTypeName() {
    return "ExcludeContentFromContentBundle";
  }
...
class IncludeContentInContentBundle extends ContentBundleAction {
   ...
   */
  public function getXsiTypeName() {
    return "IncludeContentInContentBundle";
  }
...
class ContentBundleService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201302/ContentBundleService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    $options["classmap"] = ContentBundleService::$classmap;
    parent::__construct($wsdl, $options, $user, 'ContentBundleService', 'https://www.google.com/apis/ads/publisher/v201302');
  }
  ...
  public function createContentBundle($contentBundle) {
    $arg = new createContentBundle($contentBundle);
    $result = $this->__soapCall("createContentBundle", array($arg));
    return $result->rval;
  }
  ...
  public function createContentBundles($contentBundles) {
    $arg = new createContentBundles($contentBundles);
    $result = $this->__soapCall("createContentBundles", array($arg));
    return $result->rval;
  }
  ...
  public function getContentBundle($contentBundleId) {
    $arg = new getContentBundle($contentBundleId);
    $result = $this->__soapCall("getContentBundle", array($arg));
    return $result->rval;
  }
  ...
  public function getContentBundlesByStatement($filterStatement) {
    $arg = new getContentBundlesByStatement($filterStatement);
    $result = $this->__soapCall("getContentBundlesByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function performContentBundleAction($contentBundleAction, $filterStatement) {
    $arg = new performContentBundleAction($contentBundleAction, $filterStatement);
    $result = $this->__soapCall("performContentBundleAction", array($arg));
    return $result->rval;
  }
  ...
  public function updateContentBundle($contentBundle) {
    $arg = new updateContentBundle($contentBundle);
    $result = $this->__soapCall("updateContentBundle", array($arg));
    return $result->rval;
  }
  ...
  public function updateContentBundles($contentBundles) {
    $arg = new updateContentBundles($contentBundles);
    $result = $this->__soapCall("updateContentBundles", array($arg));
    return $result->rval;
  }
