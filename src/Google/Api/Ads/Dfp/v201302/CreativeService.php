...
class AspectRatioImageCreative extends HasDestinationUrlCreative {
  ...
  public function __construct($imageAssets = NULL, $altText = NULL, $thirdPartyImpressionUrl = NULL, $destinationUrl = NULL, $advertiserId = NULL, $id = NULL, $name = NULL, $size = NULL, $previewUrl = NULL, $appliedLabels = NULL, $lastModifiedDateTime = NULL, $customFieldValues = NULL, $CreativeType = NULL) {
    parent::__construct();
...
class ImageCreative extends BaseImageCreative {
  ...
  public function __construct($altText = NULL, $thirdPartyImpressionUrl = NULL, $overrideSize = NULL, $primaryImageAsset = NULL, $destinationUrl = NULL, $advertiserId = NULL, $id = NULL, $name = NULL, $size = NULL, $previewUrl = NULL, $appliedLabels = NULL, $lastModifiedDateTime = NULL, $customFieldValues = NULL, $CreativeType = NULL) {
    parent::__construct();
    $this->altText = $altText;
    $this->thirdPartyImpressionUrl = $thirdPartyImpressionUrl;
    $this->overrideSize = $overrideSize;
...
class ImageOverlayCreative extends BaseImageCreative {
  ...
  public function __construct($companionCreativeIds = NULL, $trackingUrls = NULL, $customParameters = NULL, $duration = NULL, $overrideSize = NULL, $primaryImageAsset = NULL, $destinationUrl = NULL, $advertiserId = NULL, $id = NULL, $name = NULL, $size = NULL, $previewUrl = NULL, $appliedLabels = NULL, $lastModifiedDateTime = NULL, $customFieldValues = NULL, $CreativeType = NULL) {
    parent::__construct();
    $this->companionCreativeIds = $companionCreativeIds;
    $this->trackingUrls = $trackingUrls;
    $this->customParameters = $customParameters;
...
class CreativeService extends DfpSoapClient {
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CreativeService', 'https://www.google.com/apis/ads/publisher/v201302');
  }
