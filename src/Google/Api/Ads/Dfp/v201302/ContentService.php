...
class CmsContent {
  ...
  public function __construct($displayName = NULL, $cmsContentId = NULL) {
...
class Content {
  ...
  public function __construct($id = NULL, $name = NULL, $status = NULL, $statusDefinedBy = NULL, $cmsSources = NULL) {
    $this->id = $id;
    $this->name = $name;
    $this->status = $status;
...
class ContentService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201302/ContentService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ContentService', 'https://www.google.com/apis/ads/publisher/v201302');
  }
