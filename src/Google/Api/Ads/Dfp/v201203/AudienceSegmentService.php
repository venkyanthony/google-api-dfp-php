...
class AudienceSegmentPage {
  ...
  public function __construct($totalResultSetSize = NULL, $startIndex = NULL, $results = NULL) {
    if(get_parent_class('AudienceSegmentPage')) parent::__construct();
...
class AudienceSegment {
  ...
  public function __construct($id = NULL, $name = NULL, $description = NULL, $status = NULL, $size = NULL, $AudienceSegmentType = NULL) {
    if(get_parent_class('AudienceSegment')) parent::__construct();
    $this->id = $id;
    $this->name = $name;
...
class AudienceSegmentStatus {
  ...
  public function __construct() {
    if(get_parent_class('AudienceSegmentStatus')) parent::__construct();
  }
}}
...
class getAudienceSegmentsByStatement {
  ...
  public function __construct($filterStatement = NULL) {
    if(get_parent_class('getAudienceSegmentsByStatement')) parent::__construct();
...
class getAudienceSegmentsByStatementResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getAudienceSegmentsByStatementResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class AudienceSegmentService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201203/AudienceSegmentService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'AudienceSegmentService', 'https://www.google.com/apis/ads/publisher/v201203');
  }
