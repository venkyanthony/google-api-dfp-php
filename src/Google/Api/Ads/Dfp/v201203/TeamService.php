...
class Team {
  ...
  public function __construct($id = NULL, $name = NULL, $description = NULL, $hasAllCompanies = NULL, $hasAllInventory = NULL, $userIds = NULL, $companyIds = NULL, $adUnitIds = NULL) {
...
class TeamService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201203/TeamService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'TeamService', 'https://www.google.com/apis/ads/publisher/v201203');
  }
