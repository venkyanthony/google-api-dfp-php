<?php
/**
 * Contains all client objects for the NetworkService service.
 *
 * PHP version 5
 *
...
class Network {
  ...
  public function __construct($id = NULL, $displayName = NULL, $networkCode = NULL, $propertyCode = NULL, $timeZone = NULL, $currencyCode = NULL, $effectiveRootAdUnitId = NULL, $contentBrowseCustomTargetingKeyId = NULL, $isTest = NULL) {
    if(get_parent_class('Network')) parent::__construct();
    $this->id = $id;
...
class getAllNetworks {
  ...
  public function __construct() {
    if(get_parent_class('getAllNetworks')) parent::__construct();
  }
}}
...
class getAllNetworksResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getAllNetworksResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getCurrentNetwork {
  ...
  public function __construct() {
    if(get_parent_class('getCurrentNetwork')) parent::__construct();
  }
}}
...
class getCurrentNetworkResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getCurrentNetworkResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
 ...
 * must be created to be used with the new network. The Google account does not
 * need to sign-up for DFP, and existing DFP accounts cannot be used; only a new
 * valid Google account is required. Data from any of your existing networks will not be
 * transferred to the new test network. Additionally, each login can only have one
 * test network. Once the test network is created, the test network can be used in
 * the API by supplying the {@link Network#networkCode} in the SOAP header or by
...
class makeTestNetwork {
  ...
  public function __construct() {
    if(get_parent_class('makeTestNetwork')) parent::__construct();
  }
}}
...
class makeTestNetworkResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('makeTestNetworkResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class updateNetwork {
  ...
  public function __construct($network = NULL) {
    if(get_parent_class('updateNetwork')) parent::__construct();
...
class updateNetworkResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('updateNetworkResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class NetworkService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201203/NetworkService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'NetworkService', 'https://www.google.com/apis/ads/publisher/v201203');
  }
  ...
  public function getAllNetworks() {
    $arg = new getAllNetworks();
    $result = $this->__soapCall("getAllNetworks", array($arg));
    return $result->rval;
  }
  ...
  public function makeTestNetwork() {
    $arg = new makeTestNetwork();
    $result = $this->__soapCall("makeTestNetwork", array($arg));
    return $result->rval;
  }
  ...
  public function updateNetwork($network) {
    $arg = new updateNetwork($network);
    $result = $this->__soapCall("updateNetwork", array($arg));
    return $result->rval;
  }
