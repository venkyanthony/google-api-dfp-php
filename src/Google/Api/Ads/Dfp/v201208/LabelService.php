...
class LabelError extends ApiError {
  ...
  public function __construct($reason = NULL, $fieldPath = NULL, $trigger = NULL, $errorString = NULL, $ApiErrorType = NULL) {
    if(get_parent_class('LabelError')) parent::__construct();
    $this->reason = $reason;
    $this->fieldPath = $fieldPath;
    $this->trigger = $trigger;
    $this->errorString = $errorString;
...
class LabelErrorReason {
  ...
  public function __construct() {
    if(get_parent_class('LabelErrorReason')) parent::__construct();
  }
}}
...
class LabelService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201208/LabelService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'LabelService', 'https://www.google.com/apis/ads/publisher/v201208');
  }
