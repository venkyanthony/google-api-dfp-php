...
class DeviceCategoryTargeting {
  ...
  public function __construct($targetedDeviceCategories = NULL, $excludedDeviceCategories = NULL) {
    if(get_parent_class('DeviceCategoryTargeting')) parent::__construct();
...
class DeviceCategory extends Technology {
  ...
  public function __construct($id = NULL, $name = NULL, $TechnologyType = NULL) {
    if(get_parent_class('DeviceCategory')) parent::__construct();
    $this->id = $id;
    $this->name = $name;
    $this->TechnologyType = $TechnologyType;
  }
...
class LineItemService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201208/LineItemService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'LineItemService', 'https://www.google.com/apis/ads/publisher/v201208');
  }
