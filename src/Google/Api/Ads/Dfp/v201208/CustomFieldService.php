<?php
/**
 * Contains all client objects for the CustomFieldService service.
 *
 * PHP version 5
 *
...
class CustomFieldErrorReason {
   ...
   */
  public function getXsiTypeName() {
    return "CustomFieldError.Reason";
  }
...
class CustomFieldService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201208/CustomFieldService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CustomFieldService', 'https://www.google.com/apis/ads/publisher/v201208');
  }
  ...
  public function createCustomField($customField) {
    $arg = new createCustomField($customField);
    $result = $this->__soapCall("createCustomField", array($arg));
    return $result->rval;
  }
  ...
  public function createCustomFieldOption($customFieldOption) {
    $arg = new createCustomFieldOption($customFieldOption);
    $result = $this->__soapCall("createCustomFieldOption", array($arg));
    return $result->rval;
  }
  ...
  public function createCustomFieldOptions($customFieldOptions) {
    $arg = new createCustomFieldOptions($customFieldOptions);
    $result = $this->__soapCall("createCustomFieldOptions", array($arg));
    return $result->rval;
  }
  ...
  public function createCustomFields($customFields) {
    $arg = new createCustomFields($customFields);
    $result = $this->__soapCall("createCustomFields", array($arg));
    return $result->rval;
  }
  ...
  public function getCustomField($customFieldId) {
    $arg = new getCustomField($customFieldId);
    $result = $this->__soapCall("getCustomField", array($arg));
    return $result->rval;
  }
  ...
  public function getCustomFieldOption($customFieldOptionId) {
    $arg = new getCustomFieldOption($customFieldOptionId);
    $result = $this->__soapCall("getCustomFieldOption", array($arg));
    return $result->rval;
  }
  ...
  public function getCustomFieldsByStatement($filterStatement) {
    $arg = new getCustomFieldsByStatement($filterStatement);
    $result = $this->__soapCall("getCustomFieldsByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function performCustomFieldAction($customFieldAction, $filterStatement) {
    $arg = new performCustomFieldAction($customFieldAction, $filterStatement);
    $result = $this->__soapCall("performCustomFieldAction", array($arg));
    return $result->rval;
  }
  ...
  public function updateCustomField($customField) {
    $arg = new updateCustomField($customField);
    $result = $this->__soapCall("updateCustomField", array($arg));
    return $result->rval;
  }
  ...
  public function updateCustomFieldOption($customFieldOption) {
    $arg = new updateCustomFieldOption($customFieldOption);
    $result = $this->__soapCall("updateCustomFieldOption", array($arg));
    return $result->rval;
  }
  ...
  public function updateCustomFieldOptions($customFieldOptions) {
    $arg = new updateCustomFieldOptions($customFieldOptions);
    $result = $this->__soapCall("updateCustomFieldOptions", array($arg));
    return $result->rval;
  }
  ...
  public function updateCustomFields($customFields) {
    $arg = new updateCustomFields($customFields);
    $result = $this->__soapCall("updateCustomFields", array($arg));
    return $result->rval;
  }
