<?php
/**
 * Contains all client objects for the ActivityGroupService service.
 *
 * PHP version 5
 *
...
class ActivityGroupService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201308/ActivityGroupService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ActivityGroupService', 'https://www.google.com/apis/ads/publisher/v201308');
  }
  ...
  public function createActivityGroup($activityGroup) {
    $arg = new createActivityGroup($activityGroup);
    $result = $this->__soapCall("createActivityGroup", array($arg));
    return $result->rval;
  }
  ...
  public function createActivityGroups($activityGroups) {
    $arg = new createActivityGroups($activityGroups);
    $result = $this->__soapCall("createActivityGroups", array($arg));
    return $result->rval;
  }
  ...
  public function getActivityGroup($activityGroupId) {
    $arg = new getActivityGroup($activityGroupId);
    $result = $this->__soapCall("getActivityGroup", array($arg));
    return $result->rval;
  }
  ...
  public function getActivityGroupsByStatement($filterStatement) {
    $arg = new getActivityGroupsByStatement($filterStatement);
    $result = $this->__soapCall("getActivityGroupsByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function updateActivityGroup($activityGroup) {
    $arg = new updateActivityGroup($activityGroup);
    $result = $this->__soapCall("updateActivityGroup", array($arg));
    return $result->rval;
  }
  ...
  public function updateActivityGroups($activityGroups) {
    $arg = new updateActivityGroups($activityGroups);
    $result = $this->__soapCall("updateActivityGroups", array($arg));
    return $result->rval;
  }
