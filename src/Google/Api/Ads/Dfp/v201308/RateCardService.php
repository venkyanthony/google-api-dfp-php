<?php
/**
 * Contains all client objects for the RateCardService service.
 *
 * PHP version 5
 *
...
class RateCardActionErrorReason {
   ...
   */
  public function getXsiTypeName() {
    return "RateCardActionError.Reason";
  }
...
class RateCardService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201308/RateCardService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    $options["classmap"] = RateCardService::$classmap;
    parent::__construct($wsdl, $options, $user, 'RateCardService', 'https://www.google.com/apis/ads/publisher/v201308');
  }
  ...
  public function createRateCard($rateCard) {
    $arg = new createRateCard($rateCard);
    $result = $this->__soapCall("createRateCard", array($arg));
    return $result->rval;
  }
  ...
  public function createRateCards($rateCards) {
    $arg = new createRateCards($rateCards);
    $result = $this->__soapCall("createRateCards", array($arg));
    return $result->rval;
  }
  ...
  public function getRateCard($rateCardId) {
    $arg = new getRateCard($rateCardId);
    $result = $this->__soapCall("getRateCard", array($arg));
    return $result->rval;
  }
  ...
  public function getRateCardsByStatement($filterStatement) {
    $arg = new getRateCardsByStatement($filterStatement);
    $result = $this->__soapCall("getRateCardsByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function performRateCardAction($rateCardAction, $filterStatement) {
    $arg = new performRateCardAction($rateCardAction, $filterStatement);
    $result = $this->__soapCall("performRateCardAction", array($arg));
    return $result->rval;
  }
  ...
  public function updateRateCard($rateCard) {
    $arg = new updateRateCard($rateCard);
    $result = $this->__soapCall("updateRateCard", array($arg));
    return $result->rval;
  }
  ...
  public function updateRateCards($rateCards) {
    $arg = new updateRateCards($rateCards);
    $result = $this->__soapCall("updateRateCards", array($arg));
    return $result->rval;
  }
