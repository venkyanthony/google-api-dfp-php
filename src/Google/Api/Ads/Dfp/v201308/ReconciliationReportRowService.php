<?php
/**
 * Contains all client objects for the ReconciliationReportRowService service.
 *
 * PHP version 5
 *
...
class ReconciliationReportRow {
   ...
   * @var integer
   */
  public $dfpImpressions;

  /**
   * @access public
   * @var integer
   */
  public $dfpLineItemDays;

  /**
   * @access public
   * @var integer
   */
  public $thirdPartyClicks;

  /**
   * @access public
   * @var integer
   */
  public $thirdPartyImpressions;

  /**
   * @access public
   * @var integer
   */
  public $thirdPartyLineItemDays;
   ...
   * @var integer
   */
  public $manualImpressions;

  /**
   * @access public
   * @var integer
   */
  public $manualLineItemDays;

  /**
   * @access public
   * @var integer
   */
  public $reconciledClicks;

  /**
   * @access public
   * @var integer
   */
  public $reconciledImpressions;

  /**
   * @access public
   * @var integer
   */
  public $reconciledLineItemDays;
...
class ReconciliationReportRowPage {
   ...
   */
  public function getXsiTypeName() {
    return "ReconciliationReportRowPage";
  }
...
class ReconciliationReportRowService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201308/ReconciliationReportRowService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ReconciliationReportRowService', 'https://www.google.com/apis/ads/publisher/v201308');
  }
  ...
  public function getReconciliationReportRowsByStatement($filterStatement) {
    $arg = new getReconciliationReportRowsByStatement($filterStatement);
    $result = $this->__soapCall("getReconciliationReportRowsByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function updateReconciliationReportRows($reconciliationReportRows) {
    $arg = new updateReconciliationReportRows($reconciliationReportRows);
    $result = $this->__soapCall("updateReconciliationReportRows", array($arg));
    return $result->rval;
  }
