<?php
/**
 * Contains all client objects for the LineItemTemplateService service.
 *
 * PHP version 5
 *
...
class LineItemTemplateService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201308/LineItemTemplateService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'LineItemTemplateService', 'https://www.google.com/apis/ads/publisher/v201308');
  }
  ...
  public function getLineItemTemplatesByStatement($filterStatement) {
    $arg = new getLineItemTemplatesByStatement($filterStatement);
    $result = $this->__soapCall("getLineItemTemplatesByStatement", array($arg));
    return $result->rval;
  }
