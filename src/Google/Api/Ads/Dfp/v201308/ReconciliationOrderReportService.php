<?php
/**
 * Contains all client objects for the ReconciliationOrderReportService service.
 *
 * PHP version 5
 *
...
class ReconciliationOrderReport {
   ...
   */
  public function getXsiTypeName() {
    return "ReconciliationOrderReport";
  }
...
class ReconciliationOrderReportPage {
   ...
   */
  public function getXsiTypeName() {
    return "ReconciliationOrderReportPage";
  }
...
class SubmitReconciliationOrderReports extends ReconciliationOrderReportAction {
   ...
   */
  public function getXsiTypeName() {
    return "SubmitReconciliationOrderReports";
  }
...
class RevertReconciliationOrderReports extends ReconciliationOrderReportAction {
   ...
   */
  public function getXsiTypeName() {
    return "RevertReconciliationOrderReports";
  }
...
class ReconciliationOrderReportStatus {
   ...
   */
  public function getXsiTypeName() {
    return "ReconciliationOrderReportStatus";
  }
...
class ReconciliationOrderReportService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201308/ReconciliationOrderReportService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    $options["classmap"] = ReconciliationOrderReportService::$classmap;
    parent::__construct($wsdl, $options, $user, 'ReconciliationOrderReportService', 'https://www.google.com/apis/ads/publisher/v201308');
  }
  ...
  public function getReconciliationOrderReport($reconciliationOrderReportId) {
    $arg = new getReconciliationOrderReport($reconciliationOrderReportId);
    $result = $this->__soapCall("getReconciliationOrderReport", array($arg));
    return $result->rval;
  }
  ...
  public function getReconciliationOrderReportsByStatement($filterStatement) {
    $arg = new getReconciliationOrderReportsByStatement($filterStatement);
    $result = $this->__soapCall("getReconciliationOrderReportsByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function performReconciliationOrderReportAction($reconciliationOrderReportAction, $filterStatement) {
    $arg = new performReconciliationOrderReportAction($reconciliationOrderReportAction, $filterStatement);
    $result = $this->__soapCall("performReconciliationOrderReportAction", array($arg));
    return $result->rval;
  }
