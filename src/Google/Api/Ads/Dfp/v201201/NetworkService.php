...
class Network {
  ...
  public function __construct($id = NULL, $displayName = NULL, $networkCode = NULL, $propertyCode = NULL, $timeZone = NULL, $currencyCode = NULL, $effectiveRootAdUnitId = NULL, $contentBrowseCustomTargetingKeyId = NULL) {
...
class NetworkService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201201/NetworkService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'NetworkService', 'https://www.google.com/apis/ads/publisher/v201201');
  }
