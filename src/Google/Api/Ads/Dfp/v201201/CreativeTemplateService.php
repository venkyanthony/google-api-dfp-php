<?php
/**
 * Contains all client objects for the CreativeTemplateService service.
 *
 * PHP version 5
 *
...
class ApiError {
  ...
  public function getNamespace() {
    return "https://www.google.com/apis/ads/publisher/v201201";
  }
...
class CreativeTemplate {
  ...
  public function __construct($id = NULL, $name = NULL, $description = NULL, $variables = NULL, $status = NULL, $type = NULL, $isInterstitial = NULL) {
    if(get_parent_class('CreativeTemplate')) parent::__construct();
    $this->id = $id;
    $this->name = $name;
...
class CreativeTemplateError extends ApiError {
  ...
  public function __construct($reason = NULL, $fieldPath = NULL, $trigger = NULL, $errorString = NULL, $ApiErrorType = NULL) {
    if(get_parent_class('CreativeTemplateError')) parent::__construct();
    $this->reason = $reason;
    $this->fieldPath = $fieldPath;
    $this->trigger = $trigger;
    $this->errorString = $errorString;
...
class ListStringCreativeTemplateVariableVariableChoice {
   ...
   */
  public function getXsiTypeName() {
    return "ListStringCreativeTemplateVariable.VariableChoice";
  }

  public function __construct($label = NULL, $value = NULL) {
    if(get_parent_class('ListStringCreativeTemplateVariableVariableChoice')) parent::__construct();
    $this->label = $label;
    $this->value = $value;
  }
}}
...
class CreativeTemplatePage {
   ...
   */
  public function getXsiTypeName() {
    return "CreativeTemplatePage";
  }

  public function __construct($totalResultSetSize = NULL, $startIndex = NULL, $results = NULL) {
    if(get_parent_class('CreativeTemplatePage')) parent::__construct();
...
class CreativeTemplateVariable {
  ...
  public function __construct($label = NULL, $uniqueName = NULL, $description = NULL, $isRequired = NULL, $CreativeTemplateVariableType = NULL) {
    if(get_parent_class('CreativeTemplateVariable')) parent::__construct();
    $this->label = $label;
...
class AssetCreativeTemplateVariableMimeType {
   ...
   */
  public function getXsiTypeName() {
    return "AssetCreativeTemplateVariable.MimeType";
  }

  public function __construct() {
    if(get_parent_class('AssetCreativeTemplateVariableMimeType')) parent::__construct();
  }
}}
...
class CreativeTemplateErrorReason {
   ...
   */
  public function getXsiTypeName() {
    return "CreativeTemplateError.Reason";
  }

  public function __construct() {
    if(get_parent_class('CreativeTemplateErrorReason')) parent::__construct();
  }
}}
...
class CreativeTemplateStatus {
   ...
   */
  public function getXsiTypeName() {
    return "CreativeTemplateStatus";
  }

  public function __construct() {
    if(get_parent_class('CreativeTemplateStatus')) parent::__construct();
  }
}}
...
class CreativeTemplateType {
   ...
   */
  public function getXsiTypeName() {
    return "CreativeTemplateType";
  }

  public function __construct() {
    if(get_parent_class('CreativeTemplateType')) parent::__construct();
  }
}}
...
if (!class_exists("getCreativeTemplate", FALSE)) {
/**
...
class getCreativeTemplate {
  ...
  public function __construct($creativeTemplateId = NULL) {
    if(get_parent_class('getCreativeTemplate')) parent::__construct();
    $this->creativeTemplateId = $creativeTemplateId;
  }
}}

if (!class_exists("getCreativeTemplateResponse", FALSE)) {
/**
 * 
 * @package GoogleApiAdsDfp
 * @subpackage v201201
 */
class getCreativeTemplateResponse {
  /**
   * @access public
   * @var CreativeTemplate
   */
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getCreativeTemplateResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getCreativeTemplatesByStatement {
  ...
  public function __construct($filterStatement = NULL) {
    if(get_parent_class('getCreativeTemplatesByStatement')) parent::__construct();
...
class getCreativeTemplatesByStatementResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getCreativeTemplatesByStatementResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class AssetCreativeTemplateVariable extends CreativeTemplateVariable {
   ...
   */
  public function getXsiTypeName() {
    return "AssetCreativeTemplateVariable";
  }
  ...
  public function __construct($mimeTypes = NULL, $label = NULL, $uniqueName = NULL, $description = NULL, $isRequired = NULL, $CreativeTemplateVariableType = NULL) {
    if(get_parent_class('AssetCreativeTemplateVariable')) parent::__construct();
...
class LongCreativeTemplateVariable extends CreativeTemplateVariable {
   ...
   */
  public function getXsiTypeName() {
    return "LongCreativeTemplateVariable";
  }
  ...
  public function __construct($defaultValue = NULL, $label = NULL, $uniqueName = NULL, $description = NULL, $isRequired = NULL, $CreativeTemplateVariableType = NULL) {
    if(get_parent_class('LongCreativeTemplateVariable')) parent::__construct();
...
class StringCreativeTemplateVariable extends CreativeTemplateVariable {
   ...
   */
  public function getXsiTypeName() {
    return "StringCreativeTemplateVariable";
  }

  public function __construct($defaultValue = NULL, $label = NULL, $uniqueName = NULL, $description = NULL, $isRequired = NULL, $CreativeTemplateVariableType = NULL) {
    if(get_parent_class('StringCreativeTemplateVariable')) parent::__construct();
    $this->defaultValue = $defaultValue;
    $this->label = $label;
    $this->uniqueName = $uniqueName;
    $this->description = $description;
...
class UrlCreativeTemplateVariable extends CreativeTemplateVariable {
   ...
   */
  public function getXsiTypeName() {
    return "UrlCreativeTemplateVariable";
  }

  public function __construct($defaultValue = NULL, $label = NULL, $uniqueName = NULL, $description = NULL, $isRequired = NULL, $CreativeTemplateVariableType = NULL) {
    if(get_parent_class('UrlCreativeTemplateVariable')) parent::__construct();
    $this->defaultValue = $defaultValue;
    $this->label = $label;
    $this->uniqueName = $uniqueName;
    $this->description = $description;
...
class ListStringCreativeTemplateVariable extends StringCreativeTemplateVariable {
  ...
  public function __construct($choices = NULL, $allowOtherChoice = NULL, $defaultValue = NULL, $label = NULL, $uniqueName = NULL, $description = NULL, $isRequired = NULL, $CreativeTemplateVariableType = NULL) {
    if(get_parent_class('ListStringCreativeTemplateVariable')) parent::__construct();
...
class CreativeTemplateService extends DfpSoapClient {
  ...
  public static $classmap = array(
    ...
    "getCreativeTemplateResponse" => "getCreativeTemplateResponse",
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201201/CreativeTemplateService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    $options["classmap"] = CreativeTemplateService::$classmap;
    parent::__construct($wsdl, $options, $user, 'CreativeTemplateService', 'https://www.google.com/apis/ads/publisher/v201201');
  }
   ...
   * @return the {@code CreativeTemplate} uniquely identified by the given ID
   */
  public function getCreativeTemplate($creativeTemplateId) {
    $arg = new getCreativeTemplate($creativeTemplateId);
    $result = $this->__soapCall("getCreativeTemplate", array($arg));
    return $result->rval;
  }
  ...
  public function getCreativeTemplatesByStatement($filterStatement) {
    $arg = new getCreativeTemplatesByStatement($filterStatement);
    $result = $this->__soapCall("getCreativeTemplatesByStatement", array($arg));
    return $result->rval;
  }
