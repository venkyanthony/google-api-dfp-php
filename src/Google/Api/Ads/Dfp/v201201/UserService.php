...
class UserRecord {
  ...
  public function __construct($id = NULL, $name = NULL, $email = NULL, $roleId = NULL, $roleName = NULL, $preferredLocale = NULL, $teamIds = NULL, $UserRecordType = NULL) {
...
class UserService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201201/UserService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'UserService', 'https://www.google.com/apis/ads/publisher/v201201');
  }
