...
class AdUnit {
  ...
  public function __construct($id = NULL, $parentId = NULL, $name = NULL, $description = NULL, $targetWindow = NULL, $status = NULL, $adUnitCode = NULL, $adUnitSizes = NULL, $targetPlatform = NULL, $explicitlyTargeted = NULL, $inheritedAdSenseSettings = NULL, $appliedLabelFrequencyCaps = NULL, $effectiveLabelFrequencyCaps = NULL, $lastModifiedDateTime = NULL) {
...
if (!class_exists("getAdUnitSizes", FALSE)) {
/**
...
class getAdUnitSizes {
  ...
  public function __construct() {
    if(get_parent_class('getAdUnitSizes')) parent::__construct();
  }
}}

if (!class_exists("getAdUnitSizesResponse", FALSE)) {
/**
 * 
 * @package GoogleApiAdsDfp
 * @subpackage v201201
 */
class getAdUnitSizesResponse {
  /**
   * @access public
   * @var AdUnitSize[]
   */
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getAdUnitSizesResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class InventoryService extends DfpSoapClient {
  ...
  public static $classmap = array(
    ...
    "getAdUnitSizes" => "getAdUnitSizes",
    "getAdUnitSizesResponse" => "getAdUnitSizesResponse",
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201201/InventoryService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'InventoryService', 'https://www.google.com/apis/ads/publisher/v201201');
  }
  ...
  public function getAdUnitSizes() {
    $arg = new getAdUnitSizes();
    $result = $this->__soapCall("getAdUnitSizes", array($arg));
    return $result->rval;
  }
