...
class Network {
  ...
  public function __construct($id = NULL, $displayName = NULL, $networkCode = NULL, $propertyCode = NULL, $timeZone = NULL, $currencyCode = NULL, $effectiveRootAdUnitId = NULL) {
...
class NetworkService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201108/NetworkService";
