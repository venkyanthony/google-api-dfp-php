...
class CustomCreativeAsset {
  ...
  public function __construct($macroName = NULL, $assetId = NULL, $fileName = NULL, $fileSize = NULL) {
...
class CreativeService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201108/CreativeService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CreativeService', 'https://www.google.com/apis/ads/publisher/v201108');
  }
