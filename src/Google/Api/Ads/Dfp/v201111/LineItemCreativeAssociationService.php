<?php
/**
 * Contains all client objects for the LineItemCreativeAssociationService service.
 *
 * PHP version 5
 *
...
class LineItemCreativeAssociation {
  ...
  public function __construct($lineItemId = NULL, $creativeId = NULL, $manualCreativeRotationWeight = NULL, $startDateTime = NULL, $startDateTimeType = NULL, $endDateTime = NULL, $destinationUrl = NULL, $sizes = NULL, $status = NULL, $stats = NULL) {
...
class LineItemCreativeAssociationPage {
   ...
   */
  public function getXsiTypeName() {
    return "LineItemCreativeAssociationPage";
  }
...
class LineItemCreativeAssociationStatus {
   ...
   */
  public function getXsiTypeName() {
    return "LineItemCreativeAssociation.Status";
  }
...
class LineItemCreativeAssociationOperationErrorReason {
   ...
   */
  public function getXsiTypeName() {
    return "LineItemCreativeAssociationOperationError.Reason";
  }
...
class LineItemCreativeAssociationService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201111/LineItemCreativeAssociationService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'LineItemCreativeAssociationService', 'https://www.google.com/apis/ads/publisher/v201111');
  }
  ...
  public function createLineItemCreativeAssociation($lineItemCreativeAssociation) {
    $arg = new createLineItemCreativeAssociation($lineItemCreativeAssociation);
    $result = $this->__soapCall("createLineItemCreativeAssociation", array($arg));
    return $result->rval;
  }
  ...
  public function createLineItemCreativeAssociations($lineItemCreativeAssociations) {
    $arg = new createLineItemCreativeAssociations($lineItemCreativeAssociations);
    $result = $this->__soapCall("createLineItemCreativeAssociations", array($arg));
    return $result->rval;
  }
  ...
  public function getLineItemCreativeAssociation($lineItemId, $creativeId) {
    $arg = new getLineItemCreativeAssociation($lineItemId, $creativeId);
    $result = $this->__soapCall("getLineItemCreativeAssociation", array($arg));
    return $result->rval;
  }
  ...
  public function getLineItemCreativeAssociationsByStatement($filterStatement) {
    $arg = new getLineItemCreativeAssociationsByStatement($filterStatement);
    $result = $this->__soapCall("getLineItemCreativeAssociationsByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function getPreviewUrl($lineItemId, $creativeId, $siteUrl) {
    $arg = new getPreviewUrl($lineItemId, $creativeId, $siteUrl);
    $result = $this->__soapCall("getPreviewUrl", array($arg));
    return $result->rval;
  }
  ...
  public function performLineItemCreativeAssociationAction($lineItemCreativeAssociationAction, $filterStatement) {
    $arg = new performLineItemCreativeAssociationAction($lineItemCreativeAssociationAction, $filterStatement);
    $result = $this->__soapCall("performLineItemCreativeAssociationAction", array($arg));
    return $result->rval;
  }
  ...
  public function updateLineItemCreativeAssociation($lineItemCreativeAssociation) {
    $arg = new updateLineItemCreativeAssociation($lineItemCreativeAssociation);
    $result = $this->__soapCall("updateLineItemCreativeAssociation", array($arg));
    return $result->rval;
  }
  ...
  public function updateLineItemCreativeAssociations($lineItemCreativeAssociations) {
    $arg = new updateLineItemCreativeAssociations($lineItemCreativeAssociations);
    $result = $this->__soapCall("updateLineItemCreativeAssociations", array($arg));
    return $result->rval;
  }
