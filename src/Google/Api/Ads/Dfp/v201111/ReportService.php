...
class ReportQuery {
  ...
  public function __construct($dimensions = NULL, $columns = NULL, $dimensionAttributes = NULL, $startDate = NULL, $endDate = NULL, $dateRangeType = NULL, $dimensionFilters = NULL) {
...
/**
 * {@code Dimension} provides the break-down types available for running a
 * {@link ReportJob}. Aggregate and percentage columns will be calculated on
 * these groupings.
 * @package GoogleApiAdsDfp
 * @subpackage v201111
 */
...
/**
 * {@code DimensionAttribue} provides additional fields associated with a
...
class ReportService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201111/ReportService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'ReportService', 'https://www.google.com/apis/ads/publisher/v201111');
  }
