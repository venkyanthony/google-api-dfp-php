...
class InternalRedirectCreative extends Creative {
  ...
  public function __construct($internalRedirectUrl = NULL, $overrideSize = NULL, $isInterstitial = NULL, $advertiserId = NULL, $id = NULL, $name = NULL, $size = NULL, $previewUrl = NULL, $appliedLabels = NULL, $CreativeType = NULL) {
...
class TemplateCreative extends Creative {
  ...
  public function __construct($creativeTemplateId = NULL, $isInterstitial = NULL, $creativeTemplateVariableValues = NULL, $advertiserId = NULL, $id = NULL, $name = NULL, $size = NULL, $previewUrl = NULL, $appliedLabels = NULL, $CreativeType = NULL) {
...
class CreativeService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://sandbox.google.com/apis/ads/publisher/v201111/CreativeService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    ...
    parent::__construct($wsdl, $options, $user, 'CreativeService', 'https://www.google.com/apis/ads/publisher/v201111');
  }
