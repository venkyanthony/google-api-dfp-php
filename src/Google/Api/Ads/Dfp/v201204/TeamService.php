<?php
/**
 * Contains all client objects for the TeamService service.
 *
 * PHP version 5
 *
...
class Team {
  ...
  public function __construct($id = NULL, $name = NULL, $description = NULL, $hasAllCompanies = NULL, $hasAllInventory = NULL, $teamAccessType = NULL, $companyIds = NULL, $adUnitIds = NULL) {
    if(get_parent_class('Team')) parent::__construct();
    $this->id = $id;
    $this->name = $name;
...
class TeamPage {
  ...
  public function __construct($totalResultSetSize = NULL, $startIndex = NULL, $results = NULL) {
    if(get_parent_class('TeamPage')) parent::__construct();
...
if (!class_exists("createTeam", FALSE)) {
/**
...
class createTeam {
  ...
  public function __construct($team = NULL) {
    if(get_parent_class('createTeam')) parent::__construct();
    $this->team = $team;
  }
}}

if (!class_exists("createTeamResponse", FALSE)) {
/**
 * 
 * @package GoogleApiAdsDfp
 * @subpackage v201204
...
class createTeamResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('createTeamResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class createTeams {
  ...
  public function __construct($teams = NULL) {
    if(get_parent_class('createTeams')) parent::__construct();
    $this->teams = $teams;
  }
}}
...
class createTeamsResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('createTeamsResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}

if (!class_exists("getTeam", FALSE)) {
/**
...
class getTeam {
  ...
  public function __construct($teamId = NULL) {
    if(get_parent_class('getTeam')) parent::__construct();
    $this->teamId = $teamId;
  }
}}

if (!class_exists("getTeamResponse", FALSE)) {
/**
 * 
 * @package GoogleApiAdsDfp
 * @subpackage v201204
...
class getTeamResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getTeamResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class getTeamsByStatement {
  ...
  public function __construct($filterStatement = NULL) {
    if(get_parent_class('getTeamsByStatement')) parent::__construct();
...
class getTeamsByStatementResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('getTeamsByStatementResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}

if (!class_exists("updateTeam", FALSE)) {
/**
...
class updateTeam {
  ...
  public function __construct($team = NULL) {
    if(get_parent_class('updateTeam')) parent::__construct();
    $this->team = $team;
  }
}}

if (!class_exists("updateTeamResponse", FALSE)) {
/**
 * 
 * @package GoogleApiAdsDfp
 * @subpackage v201204
...
class updateTeamResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('updateTeamResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class updateTeams {
  ...
  public function __construct($teams = NULL) {
    if(get_parent_class('updateTeams')) parent::__construct();
    $this->teams = $teams;
  }
}}
...
class updateTeamsResponse {
  ...
  public function __construct($rval = NULL) {
    if(get_parent_class('updateTeamsResponse')) parent::__construct();
    $this->rval = $rval;
  }
}}
...
class TeamService extends DfpSoapClient {
   ...
   * @var string
   */
  public static $endpoint = "https://www.google.com/apis/ads/publisher/v201204/TeamService";
  ...
  public function __construct($wsdl=null, $options, $user) {
    $options["classmap"] = TeamService::$classmap;
    parent::__construct($wsdl, $options, $user, 'TeamService', 'https://www.google.com/apis/ads/publisher/v201204');
  }
  ...
  public function createTeam($team) {
    $arg = new createTeam($team);
    $result = $this->__soapCall("createTeam", array($arg));
    return $result->rval;
  }
  ...
  public function createTeams($teams) {
    $arg = new createTeams($teams);
    $result = $this->__soapCall("createTeams", array($arg));
    return $result->rval;
  }
  ...
  public function getTeam($teamId) {
    $arg = new getTeam($teamId);
    $result = $this->__soapCall("getTeam", array($arg));
    return $result->rval;
  }
  ...
  public function getTeamsByStatement($filterStatement) {
    $arg = new getTeamsByStatement($filterStatement);
    $result = $this->__soapCall("getTeamsByStatement", array($arg));
    return $result->rval;
  }
  ...
  public function updateTeam($team) {
    $arg = new updateTeam($team);
    $result = $this->__soapCall("updateTeam", array($arg));
    return $result->rval;
  }
  ...
  public function updateTeams($teams) {
    $arg = new updateTeams($teams);
    $result = $this->__soapCall("updateTeams", array($arg));
    return $result->rval;
  }
