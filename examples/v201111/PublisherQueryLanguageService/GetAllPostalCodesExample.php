<?php
/**
 * This example gets all postal codes available to target.
 *
...
try {
  ...
  $pqlService = $user->GetService('PublisherQueryLanguageService', 'v201111');

  // Create statement to select all targetable cities.
  $selectStatement =
      new Statement('SELECT * FROM Postal_Code WHERE targetable = true '
          . 'LIMIT 500');
