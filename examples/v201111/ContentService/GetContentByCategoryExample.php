 ...
 *
 * Tags: ContentService, NetworkService, CustomTargetingService
 *
 * PHP version 5
 *
...
try {
  ...
  $contentService = $user->GetService('ContentService', 'v201111');

  // Get the NetworkService.
  $networkService = $user->GetService('NetworkService', 'v201111');
