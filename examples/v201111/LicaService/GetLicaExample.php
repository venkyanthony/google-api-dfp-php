 ...
 * GetAllLineItemsExample.php. To determine which creatives exit, run
 * GetAllCreativesExample.php.
 *
 * Tags: LineItemCreativeAssociationService
 *
 * PHP version 5
 *
...
try {
  ...
  $licaService = $user->GetService('LineItemCreativeAssociationService', 'v201111');
  ...
  // Get the LICA.
  $lica = $licaService->getLineItemCreativeAssociation($lineItemId,
      $creativeId);
  ...
  if (isset($lica)) {
    ...
    print "No LICA found for this ID.\n";
  }
} catch (Exception $e) {
  print $e->getMessage() . "\n";
}
