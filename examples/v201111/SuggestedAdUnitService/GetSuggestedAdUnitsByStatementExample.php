<?php
/**
 * This example gets suggested ad units that have exactly 10 requests. The
...
try {
  ...
  // Create a statement to only select suggested ad units with exactly 10
  // requests.
  $filterStatement =
      new Statement("WHERE numRequests = :numRequests LIMIT 500",
      MapUtils::GetMapEntries(array('numRequests' => new NumberValue(10))));
