 ...
 *
 * Tags: PlacementService, InventoryService
 *
 * PHP version 5
 *
...
try {
  ...
  $placementService = $user->GetService('PlacementService', 'v201111');

  // Get the InventoryService.
  $inventoryService = $user->GetService('InventoryService', 'v201111');
  ...
  $placements = $placementService->createPlacements(
      array($mediumSquareAdUnitPlacement, $skyscraperAdUnitPlacement,
          $bannerAdUnitPlacement));
