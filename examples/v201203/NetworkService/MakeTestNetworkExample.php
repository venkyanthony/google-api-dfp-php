 ...
 * to other services. Please note that a Google account can create one
 * test network; any future calls to makeTestNetwork will fail.
 *
...
try {
  ...
  $networkService = $user->GetService('NetworkService', 'v201203');
