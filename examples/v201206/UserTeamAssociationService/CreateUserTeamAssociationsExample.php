 ...
 * two. To determine which teams exist, run GetAllTeamsExample.php. To
 * determine which users exist, run GetAllUsersExample.php.
 *
...
try {
  ...
  $userTeamAssociationService =
      $user->GetService('UserTeamAssociationService', 'v201206');
