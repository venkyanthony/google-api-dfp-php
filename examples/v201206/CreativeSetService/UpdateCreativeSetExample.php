...
try {
  ...
  $creativeSetService = $user->GetService('CreativeSetService', 'v201206');
  ...
  # Get creative set.
  $creativeSet = $creativeSetService->getCreativeSet($creativeSetID);
  ...
  if (isset($creativeSet)) {
    ...
    print "No creative set found to update.\n";
  }
} catch (Exception $e) {
  print $e->getMessage() . "\n";
}
