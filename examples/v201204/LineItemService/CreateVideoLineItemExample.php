 ...
 * items exist, run GetAllLineItemsExample.php. To determine which orders exist,
 * run GetAllOrdersExample.php. To determine which placements exist, run
...
try {
  ...
  $lineItemService = $user->GetService('LineItemService', 'v201204');
  ...
  $videoPositionTargeting->targetedVideoPositions = array('PREROLL');
  ...
  $lineItem = $lineItemService->createLineItems($lineItem);
