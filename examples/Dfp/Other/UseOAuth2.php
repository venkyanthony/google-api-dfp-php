<?php
/**
 * This example demonstrates how to authenticate using OAuth 2. This example
...
function UseOAuth2Example($clientId, $clientSecret) {
  ...
  // Create the DfpUser and set the OAuth2 info.
  $user = new DfpUser();
  ...
  // Get the networks you can access from this Google account.
  ...
  foreach ($networks as $network) {
   ...
   .  '" and display name "' . $network->displayName . "\" was found.\n";
   $i++;
  }
}
