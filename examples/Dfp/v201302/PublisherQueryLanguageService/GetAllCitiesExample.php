 ...
 * http://code.google.com/apis/dfp/docs/reference/v201302/PublisherQueryLanguageService.html
 *
...
try {
  ...
  $pqlService = $user->GetService('PublisherQueryLanguageService', 'v201302');
