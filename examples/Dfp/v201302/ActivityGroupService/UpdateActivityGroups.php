...
try {
  ...
  $activityGroupService = $user->GetService('ActivityGroupService', 'v201302');
  ...
  $activityGroup = $activityGroupService->getActivityGroup($activityGroupId);
  ...
  if (isset($activityGroups)) {
    ...
    printf("No activity groups were updated.\n");
  }
} catch (Exception $e) {
  printf("%s\n", $e->getMessage());
}
