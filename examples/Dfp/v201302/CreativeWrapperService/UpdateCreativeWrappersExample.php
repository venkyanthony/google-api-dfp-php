...
try {
  ...
  $creativeWrapperService = $user->GetCreativeWrapperService('v201302');
  ...
  if (isset($creativeWrapper)) {
    ...
    if (isset($creativeWrappers)) {
      ...
      printf('No creative wrappers were updated.');
    }
  } else {
