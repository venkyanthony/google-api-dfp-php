<?php
/**
 * This example gets all contacts. To create contacts, run CreateContacts.php.
 *
...
try {
  ...
  $contactService = $user->GetService('ContactService', 'v201302');

  // Statement parts to help build a statement to select all contacts.
