<?php
/**
 * This panel lists the creative templates in the account as an HTML list.
 *
 * PHP version 5
 *
...
try {
  ...
  // Create service.
  $creativeTemplateService = $user->GetService('CreativeTemplateService');

  // Get all creative templates.
  $creativeTemplates = $filterText == ''
      ? ServiceUtils::GetAllObjects($creativeTemplateService,
          'getCreativeTemplatesByStatement', $filterText)
      : ServiceUtils::GetSomeObjects($creativeTemplateService,
          'getCreativeTemplatesByStatement', $filterText);

  if (sizeof($creativeTemplates) > 0) {
    // Output HTML.
    DisplayUtils::PrintNameAndIdList($creativeTemplates, 'creativeTemplate');
  } else {
