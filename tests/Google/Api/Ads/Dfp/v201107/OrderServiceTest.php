...
class OrderServiceTest extends PHPUnit_Framework_TestCase {
  ...
  public function testCreateOrders() {
    ...
    $order1->externalOrderId = $testOrder1->externalOrderId;
    $order1->lastModifiedByApp = $testOrder1->lastModifiedByApp;
    ...
    $order2->externalOrderId = $testOrder2->externalOrderId;
    $order2->lastModifiedByApp = $testOrder2->lastModifiedByApp;
