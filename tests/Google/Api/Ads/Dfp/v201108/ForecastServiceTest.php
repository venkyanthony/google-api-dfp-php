...
class ForecastServiceTest extends PHPUnit_Framework_TestCase {
  ...
  protected function setUp() {
    ...
    $this->service = $this->user->GetService('ForecastService', $this->version);
  ...
  public function testGetForecast() {
    ...
    $lineItem->creativePlaceholders = array(
        new CreativePlaceholder(new Size(300, 250, FALSE)));
    ...
    try {
      ...
      $this->assertEquals('NO_FORECAST_YET', $errors[0]->reason);
    }
  }
